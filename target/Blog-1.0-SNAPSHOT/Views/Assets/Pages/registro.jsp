...
<body class="grid content-center justify-center min-h-screen w-full">
    <div class="min-h-screen w-full absolute -z-10 fondoUno">
    </div>
    <section class="grid bg-white p-7 rounded-lg shadow-md w-96">
        ...
        <form action="../../../SvUsuario" method="POST" class="grid">
            <label class="bg-white text-meBlack input input-bordered flex items-center gap-2 mb-4">
                ...
                <input type="text" class="grow text-meBlack" placeholder="Correo institucional" name="correoInstitucional"/>
            </label>
            <label class="bg-white text-meBlack input input-bordered flex items-center gap-2 mb-4">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" class="w-4 h-4 opacity-70"><path fill-rule="evenodd" d="M14 6a4 4 0 0 1-4.899 3.899l-1.955 1.955a.5.5 0 0 1-.353.146H5v1.5a.5.5 0 0 1-.5.5h-2a.5.5 0 0 1-.5-.5v-2.293a.5.5 0 0 1 .146-.353l3.955-3.955A4 4 0 1 1 14 6Zm-4-2a.75.75 0 0 0 0 1.5.5.5 0 0 1 .5.5.75.75 0 0 0 1.5 0 2 2 0 0 0-2-2Z" clip-rule="evenodd" /></svg>
                <input type="password" class="grow text-meBlack" placeholder="Contraseña" name="contraseña"/>
            </label>
            <label class="bg-white text-meBlack input input-bordered flex items-center gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" class="w-4 h-4 opacity-70"><path fill-rule="evenodd" d="M14 6a4 4 0 0 1-4.899 3.899l-1.955 1.955a.5.5 0 0 1-.353.146H5v1.5a.5.5 0 0 1-.5.5h-2a.5.5 0 0 1-.5-.5v-2.293a.5.5 0 0 1 .146-.353l3.955-3.955A4 4 0 1 1 14 6Zm-4-2a.75.75 0 0 0 0 1.5.5.5 0 0 1 .5.5.75.75 0 0 0 1.5 0 2 2 0 0 0-2-2Z" clip-rule="evenodd" /></svg>
                <input type="password" class="grow text-meBlack" placeholder="Confirmar contraseña" name="confirmarContraseña"/>
            </label>
            <button class="btn bg-meGreen border-none text-white mt-4 hover:bg-meGreen" type="submit">Registrar</button>
        </form>
